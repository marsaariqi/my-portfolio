...
const ClientHome = () => {
  ...
  const [randomNumberB, setRandomNumberB] = useState(
    Math.floor(Math.random() * 9) + 1
  );
        ...
        <div>
          <AnimatePresence>
            ...
            >
              <h1 className="text-5xl text-gray-50 md:text-7xl px-8 font-bold w-fit mt-4 cursor-default hover:text-accent ease-in-out duration-200">
                Hi!
                <br />
                <span className="text-gray-50">I'm</span>
                <span
                ...
                <br />I Do{" "}
                <span className="text-pretty text-info">Web Development</span>{" "}
                Stuff
              </h1>
            </motion.div>
          </AnimatePresence>
          <AnimatePresence>
            <motion.div
              ...
              transition={{ type: "spring", duration: 0.8, bounce: 0.3 }}
            >
              <h2 className="px-8 mt-5 text-md lg:text-lg font-semibold text-left w-fit cursor-default">
                Mostly <span className="text-success">Front-End</span> stuff,
                but I do <span className="text-accent">Full-Stack</span> too!😁
              </h2>
            </motion.div>
          </AnimatePresence>
          <AnimatePresence>
            ...
            >
              <div className="flex gap-2 px-8 mt-2 mb-10">
                <Link
                  href="https://www.linkedin.com/in/marsaariqi"
                  target="_blank"
                  className="hover:text-blue-300 hover:scale-105 ease-in duration-200"
                >
                  <FaLinkedin size={40} />
                </Link>
                <Link
                  ...
                  target="_blank"
                  className="hover:text-gray-50 hover:scale-105 ease-in duration-200"
                >
                  <FaGithub size={40} />
                </Link>
                <Link
                  ...
                  target="_blank"
                  className="hover:text-green-300 hover:scale-105 ease-in duration-200"
                >
                  <FaSpotify size={40} />
                </Link>
                <Link
                  ...
                  target="_blank"
                  className="hover:text-indigo-400 hover:scale-105 ease-in duration-200"
                >
                  <FaDiscord size={40} />
                </Link>
              </div>
          ...
          >
            <div className="stats shadow w-fit scale-[.85] md:scale-100 cursor-default mt-0 sm:-mt-8 text-primary bg-zinc-900">
              <div className="stat place-items-center">
                <div className="stat-value mb-2 hover:text-gray-50 hover:scale-105 ease-in-out duration-200">
                  {isLoading ? (
              ...
              <div className="stat place-items-center">
                <div className="stat-value flex hover:text-gray-50 hover:scale-105 ease-in-out duration-200">
                  {isLoading ? (
            ...
            <div className="mockup-browser border-2 bg-neutral-950 mt-4 mb-5 cursor-default border-dashed border-success">
              ...
              <div className="flex flex-col justify-center py-5 bg-black p-8 w-full items-center">
                <div className="mockup-code bg-zinc-900 max-w-xs w-full">
                  <pre data-prefix="$">
                    <code>npm i Resume.pdf</code>
                  </pre>
                  <pre data-prefix=">" className="text-warning">
                    {isLoading ? (
                      <code suppressHydrationWarning>
                        installing{currentDots}
                      </code>
                    ) : (
