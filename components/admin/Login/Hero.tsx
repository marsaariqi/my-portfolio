...
const LoginAwbibib: React.FC<LoginAwbibibProps> = ({ setAuthAwbibib }) => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      await awbibib({ username, password });
  ...
  return (
    <>
      <AnimatePresence>
        <motion.div className="flex justify-center items-center  h-[80dvh] w-full p-2 mt-40">
          <div className="mockup-browser border border-base-300 p-2">
            <div className="mockup-browser-toolbar">
              <a
                href="/"
                className="input border border-base-300 hover:text-gray-50"
              >
                https://marsaariqi.my.id
              </a>
            </div>
              ...
              <div className="mockup-code m-5 text-xl w-fit mx-auto">
                <pre data-prefix="$" className="text-warning mb-2">
                  <input
                    ...
                    className="input input-ghost w-fit max-w-xs text-xl"
                  />
                </pre>
